...
.PHONY: help build run stop logs shell db-push db-studio clean dev prod publish setup setup-demo test test-e2e test-e2e-ui test-e2e-headed test-all test-docker rebuild fresh fresh-demo ci ci-docker
