                                  ...
                                  <>
                                    <div className="grid grid-cols-2 gap-2">
                                      <div>
                                        ...
                                        <Input
                                          type="datetime-local"
                                          value={option.startTime ? new Date(option.startTime).toISOString().slice(0, 16) : ''}
                                          onChange={(e) => {
                                      ...
                                      <div>
                                        ...
                                        <Input
                                          type="datetime-local"
                                          value={option.endTime ? new Date(option.endTime).toISOString().slice(0, 16) : ''}
                                          onChange={(e) => {
                                            const updated = [...editingOptions];
                                            const newEndTime = e.target.value ? new Date(e.target.value).toISOString() : '';
                                            const newText = isAutoGeneratedText(option.text) 
