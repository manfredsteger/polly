                                      ...
                                      <div>
                                        ...
                                        <DatePicker
                                          ...
                                          onDateChange={(date) => {
                                            ...
                                            const newStartTime = combineDateAndTime(date, currentStartTime);
                                            const newEndTime = combineDateAndTime(date, currentEndTime);
                                        ...
                                        <div>
                                          ...
                                          <TimePickerDropdown
                                            ...
                                            onChange={(time) => {
                                              ...
                                              const newStartTime = combineDateAndTime(currentDate, time);
                                              const newText = isAutoGeneratedText(option.text) 
                                        ...
                                        <div>
                                          ...
                                          <TimePickerDropdown
                                            ...
                                            onChange={(time) => {
                                              ...
                                              const newEndTime = combineDateAndTime(currentDate, time);
                                              const newText = isAutoGeneratedText(option.text) 
