...
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](https://github.com/manfredsteger/polly/blob/v0.1.0-beta.3/LICENSE)
...
git clone --branch v0.1.0-beta.3 --depth 1 https://github.com/manfredsteger/polly.git
cd polly
cp .env.example .env
...
docker run -d \
  ...
  manfredsteger/polly:0.1.0-beta.3
```
...
services:
  ...
  app:
    image: manfredsteger/polly:0.1.0-beta.3
    ports:
      - "3080:5000"
    volumes:
...
- [Self-Hosting Guide](https://github.com/manfredsteger/polly/blob/v0.1.0-beta.3/docs/SELF-HOSTING.md) — Full deployment instructions, reverse proxy, backups
- [Release Notes](https://github.com/manfredsteger/polly/releases) — Changelog and download links
- [Flutter Integration](https://github.com/manfredsteger/polly/blob/v0.1.0-beta.3/docs/FLUTTER_INTEGRATION.md) — Mobile app API documentation
- [OpenAPI Spec](https://github.com/manfredsteger/polly/blob/v0.1.0-beta.3/docs/openapi.yaml) — Complete API reference

## License

Polly is open-source software licensed under the [MIT License](https://github.com/manfredsteger/polly/blob/v0.1.0-beta.3/LICENSE).
